...
async def generate_and_poll_talk():
    ...
    payload = {
        # Using D-ID's pre-aligned stock presenter image hosted on their own CDN
        ...
        "script": {
            ...
            "input": "Namaste Sakshi, Stock image test of talks API."
        },
        "config": {
            "fluent": "false",
            "pad_audio": "0.0"
    ...
    print("Sending request to POST /talks using stock image...")
    ...
    async with httpx.AsyncClient(timeout=15.0) as client:
        ...
        # Poll for 80 times with 3.0s interval
        for i in range(80):
